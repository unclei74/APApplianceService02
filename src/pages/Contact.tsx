    ...
    <main className="container">
      ...
      <section className="grid">
        <article className="card">
          ...
          <p><strong>Phone (call/text):</strong> <a href={`tel:${SITE.phoneTel}`}>{SITE.phone}</a></p>
          ...
          >
            <div className="twoCol">
              ...
              <div>
                ...
                <input id="phone" required value={form.phone} onChange={(e) => onChange("phone", e.target.value)} placeholder="Required" />
              </div>
            </div>
